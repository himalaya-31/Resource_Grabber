	...
	<div id="wrapper" class="clearfix">
		...
		<section id="content">
		  <form action="/searchController" method="post">
								<div class="input-group" style="/* width: 50%;margin-top: 50px; */width: 40%; margin-top: 10%; left: 30%;">
									<input type="text" name="itemName" class="form-control" value="" placeholder="Search.." required>
								<button type="submit" style="position: absolute; border-radius: 5px; font-size: 19px; margin-left: -3px;"><i class="icon-line-search"></i></button>	
								</div>
				   ...
				   %>
							...
							<div class="product <%=li.get(i).category %> clearfix">
								<div class="product-image">
									<a href="<%="/shopSingle?blob-key="+li.get(i).blobKeyPic%>"><img src="<%=servingUrl%>" style="height: 270px; width: 270px"alt="Checked Short Dress"></a>
									
									<!-- <a href="dynamic.html"><img src="images/shop/dress/1.jpg"></a> -->
								</div>
								
								<div class="product-desc center">
									<div class="product-title"><h3><a href="<%="/shopSingle.jsp?blob-key="+li.get(i).blobKeyPic%>"><%= li.get(i).itemName%></a></h3></div>
							...
							<%} 
				        	   else if(li.get(i).itemName.equalsIgnoreCase(itemName)){
				        		   BlobKey bk = new BlobKey(li.get(i).blobKeyPic);
